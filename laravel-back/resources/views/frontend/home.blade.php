        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="ts-intro">
              ...
              <p>Stony Track providers of MEP Engineering Products
                and Services (Fire Protection System and HVAC System,
                Electrical Sub-station, Generator, Plumbing Services
                and Others related to MEP).
              </p>
          ...
          <div class="col-lg-6 mt-4 mt-lg-0">
            ...
            <p>We will serve all our customers: owners,
              clients, contractors, suppliers and all
              A/E team members. We will listen to their
            ...
            <div class="accordion accordion-group" id="our-values-accordion">
              <div class="card">
                ...
                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                  ...
                  <div class="card-body">
                    First and foremost, always. It’s in our hands. Safety is the cornerstone of Austin’s business and no
                    work is ever too urgent or too important that we cannot take time to do it safely. Safety is a way
                    of life; a choice that becomes an instinct.
                  </div>
                </div>
              </div>
              <div class="card">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#our-values-accordion">
                  <div class="card-body">
                    We will serve all our customers: owners, clients, contractors, suppliers and all A/E team members.
                    We will listen to their needs and respond appropriately. We will demonstrate humility to them. We
                    will listen more than we talk. We will be polite to everyone. We will show mutual respect for all we
                    contact. We will work to build each person’s self-esteem.
                  </div>
                </div>
              </div>
              <div class="card">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                  data-parent="#our-values-accordion">
                  <div class="card-body">
                    Errors can be forgiven; breaking our word won’t be accepted. We will not tolerate any breach of
                    integrity. We will face it, repent, and make amends, if necessary, and correct the root cause. We
                    will strictly follow the engineering code of ethics in all our professional dealings.
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="ts-service-box d-flex">
              ...
              <div class="ts-service-box-info">
                <h3 class="service-box-title"><a href="{{ ('projects') }}">Fire Protection System</a></h3>
                <p>We live in a technology-driven world. In recent years, the building fire protection…</p>
              </div>
            </div><!-- Service 1 end -->
            ...
            <div class="ts-service-box d-flex">
              ...
              <div class="ts-service-box-info">
                <h3 class="service-box-title"><a href="{{ ('projects') }}">HVAC System</a></h3>
                <p>Our dedicated HVAC Services team is here for you …</p>
              </div>
            </div><!-- Service 2 end -->
            ...
            <div class="ts-service-box d-flex">
              ...
              <div class="ts-service-box-info">
                <h3 class="service-box-title"><a href="{{ ('projects') }}">Electrical Solutions</a></h3>
                <p>Electrical Services is fully committed to providing our clients with energy efficient …</p>
              </div>
            </div><!-- Service 3 end -->
          ...
          <div class="col-lg-4 mt-5 mt-lg-0 mb-4 mb-lg-0">
            <div class="ts-service-box d-flex">
              ...
              <div class="ts-service-box-info">
                <h3 class="service-box-title"><a href="{{ ('projects') }}">Plumbing Services</a></h3>
                <p>Our plumbing engineers design systems with your “whole building” …</p>
              </div>
            </div><!-- Service 4 end -->
            ...
            <div class="ts-service-box d-flex">
              ...
              <div class="ts-service-box-info">
                <h3 class="service-box-title"><a href="{{ ('projects') }}">ELEVATOR & ESCALATOR</a></h3>
                <p>Stonytrack supply and provide maintenance services of Elevator and Escalator in the Bangladesh
                  market…</p>
              </div>
            </div><!-- Service 5 end -->
            ...
            <div class="ts-service-box d-flex">
              ...
              <div class="ts-service-box-info">
                <h3 class="service-box-title"><a href="{{ ('projects') }}">SAFETY CONSULTANCY</a></h3>
                <p>Our safety consultants visit the workplaces and evaluate them for potential risks and hazards and
                  derive a safety plan against people and property ...</p>
              </div>
            </div><!-- Service 6 end -->
          </div><!-- Col end -->
        </div><!-- Content row end -->
                  ...
                  <div class="project-item-info">
                    <div class="project-item-info-content">
                      <h3 class="project-item-title">
                        <a href="{{ ('projects') }}">WE JUST COMPLETED BRITISH AMERICAN TOBACO BANGLADESH (BATB)</a>
                      </h3>
              ...
              <div class="col-lg-4 col-md-6 shuffle-item" data-groups="[&quot;industrial&quot;]">
                <div class="project-img-container">
                  ...
                  <div class="project-item-info">
                    <div class="project-item-info-content">
                      <h3 class="project-item-title">
                        <a href="{{ ('projects') }}">HAVE DONE PN COMPOSIT LTD. (RMG), AMBUGH</a>
                      </h3>
              ...
              <div class="col-lg-4 col-md-6 shuffle-item"
                ...
                <div class="project-img-container">
                  ...
                  <div class="project-item-info">
                    <div class="project-item-info-content">
                      <h3 class="project-item-title">
                        <a href="{{ ('projects') }}">ONGOING PROJECT IS AIRTRAFIC CONTROL TOWER</a>
                      </h3>
    ...
    <section id="news" class="news">
      <div class="container">
        <div class="row text-center">
          <div class="col-12">
            <h2 class="section-title">Work of On Going</h2>
        ...
        <div class="row">
            ...
            <div class="latest-post">
              <div class="latest-post-media">
                <a href="news-single.html" class="latest-post-img">
                  <img loading="lazy" class="img-fluid" src="{{ asset('assets/images/news/BATB.JPG') }}" alt="img">
                </a>
              </div>
              <div class="post-body">
                <h4 class="post-title">
                  <a href="news-single.html" class="d-inline-block">
                    WE JUST COMPLETED BRITISH AMERICAN TOBACO BANGLADESH (BATB), SAVAR, DHAKA
                  </a>
                </h4>
                <div class="latest-post-meta">
                  <span class="post-item-date">
                    <i class="fa fa-clock-o"></i> Fire Detection, Hydrant, Sprinkler and Suppression System
                  </span>
                </div>
              </div>
            </div><!-- Latest post end -->
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="latest-post">
              <div class="latest-post-media">
                <a href="news-single.html" class="latest-post-img">
                  <img loading="lazy" class="img-fluid" src="{{ asset('assets/images/news/ATCTB-Tower.jpg') }}" alt="img">
                </a>
              </div>
              <div class="post-body">
                <h4 class="post-title">
                  <a href="news-single.html" class="d-inline-block">
                    ONGOING PROJECT IS AIRTRAFIC CONTROL TOWER AT HAZRAT SHAHJALAL INTERNATIONAL AIRPORT, DHAKA
                  </a>
                </h4>
                <div class="latest-post-meta">
                  <span class="post-item-date">
                    <i class="fa fa-clock-o"></i> Fire Detection, Hydrant, Suppression, Fire Door, Safety Equipment’s
                    and PA System
                  </span>
                </div>
              </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="latest-post">
              <div class="latest-post-media">
                <a href="news-single.html" class="latest-post-img">
                  <img loading="lazy" class="img-fluid" src="{{ asset('assets/images/news/PN-Composit.jpg') }}" alt="img">
                </a>
              </div>
              <div class="post-body">
                <h4 class="post-title">
                  <a href="news-single.html" class="d-inline-block">
                    HAVE DONE PN COMPOSIT LTD. (RMG), AMBUGH, GAZIPUR
                  </a>
                </h4>
                <div class="latest-post-meta">
                  <span class="post-item-date">
                    <i class="fa fa-clock-o"></i> Fire Detection, Hydrant, Sprinkler and Building Joint System
                  </span>
                </div>
              </div>
            </div><!-- Latest post end -->
