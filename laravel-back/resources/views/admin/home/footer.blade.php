                ...
                <div class="row">
                  ...
                  <div class="col-sm-8">
                    <div class="input-group input-group-merge">
                      ...
                      <textarea name="about_txt" rows="5" id="basic-icon-default-message" class="form-control"
                        placeholder="Content Here"
                        aria-label="Content Here"
                        aria-describedby="basic-icon-default-message2">{{ $footer->about_txt ?? '' }}</textarea>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-12">
                        <textarea id="mytextarea">{{ $footer->about_txt ?? '' }}</textarea>
                  </div>
                </div>
            </div>
          </div>
