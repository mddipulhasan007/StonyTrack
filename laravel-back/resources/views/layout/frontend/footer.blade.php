        ...
        <div class="container">
          <div class="row justify-content-between">
            ...
            <div class="col-lg-3 col-md-6 mt-5 mt-lg-0 footer-widget">
              ...
              <ul class="list-arrow">
                <li><a href="{{ $footer->s_menu_url1 ?? '' }}">Fire Detection & Alarm System</a></li>
                <li><a href="{{ $footer->s_menu_url2 ?? '' }}">Fire Protection System</a></li>
                <li><a href="{{ $footer->s_menu_url3 ?? '' }}">Fire Safety Consultancy</a></li>
                <li><a href="{{ $footer->s_menu_url4 ?? '' }}">HVAC System</a></li>
                <li><a href="{{ $footer->s_menu_url5 ?? '' }}">Electrical Sub-Station</a></li>
                <li><a href="{{ $footer->s_menu_url6 ?? '' }}">Electrical Generator</a></li>
              </ul>
            </div><!-- Col end -->
          </div><!-- Row end -->
        </div><!-- Container end -->
            ...
            <div class="col-md-6">
              <div class="copyright-info">
                <span>Copyright &copy;
                  ...
                  </script>, {{ $footer->copyright_txt ?? '' }} <a href="{{ url('/') }}">Stony Track</a>
                </span>
              </div>
            </div>
