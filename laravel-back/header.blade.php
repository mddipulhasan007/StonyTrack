      ...
      <!-- Menu -->
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <a href="/dashboard" class="app-brand-link">
                ...
                <span class="app-brand-text demo menu-text fw-bolder ms-2">Stony Track</span>
            </a>
            ...
            <li class="menu-header small text-uppercase d-none"><span class="menu-header-text">Projects</span></li>
            <!-- Forms -->
            <li class="menu-item d-none">
                <a href="javascript:void(0);" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-detail"></i>
                  <div data-i18n="Form Layouts">Manage Projects</div>
                </a>
            </li>
            <!-- Tables -->
            <li class="menu-item d-none">
            ...
            <li class="menu-header small text-uppercase d-none"><span class="menu-header-text">Media & News</span></li>
            <!-- Forms -->
            <li class="menu-item d-none">
                <a href="javascript:void(0);" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-detail"></i>
            ...
            <!-- Components -->
            <li class="menu-header small text-uppercase d-none"><span class="menu-header-text">Example Design</span></li>
            <!-- Cards -->
            <li class="menu-item d-none">
